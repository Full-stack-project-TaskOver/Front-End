  ...
  return (
    <>
      <Modal onClose={onClose} isOpen={isOpen} size={"full"}>
        ...
        <ModalContent
          ...
          <ModalBody px={6}>
            ...
            <Divider />
            <Heading pt={6} as="h2" size="lg">
              Description
            </Heading>
            <Text py={5}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Reiciendis, perferendis corporis? Inventore quam expedita error
              tempore, et iure sint est quibusdam placeat maxime sunt? Suscipit
              magni recusandae sunt at quidem.
            </Text>
            <Divider />
      ...
      <Box
        ...
        <Spacer />
        <Level userPoints={500} color={""} size={"1rem"} />
      </Box>
    </>
  );
}
...
export default Task;
function useTaskDragAndDrop<T>(arg0: { task: TaskModel; index: number; }, handleDropHover: (i: number, j: number) => void): { ref: any; isDragging: any; } {
